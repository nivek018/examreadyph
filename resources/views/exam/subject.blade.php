...
>
    ...
    <section class="py-14 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                <span class="badge-blue text-xs mb-2.5 inline-block">Official Exam Guide</span>
                <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white">
                    {{ $exam->name }} — Complete Study Guide & Coverage
                </h2>
                <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-2 max-w-2xl mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3.5 mb-10">
                <div class="card flat-card p-3.5 text-center bg-white dark:bg-slate-800">
                ...
                <div class="card flat-card p-3.5 text-center bg-white dark:bg-slate-800">
                    ...
                    <div class="text-base font-extrabold text-rose-600 dark:text-rose-400 mt-0.5">Prohibited</div>
                </div>

                <div class="card flat-card p-3.5 text-center bg-white dark:bg-slate-800">
                    <div class="text-xs text-slate-500 dark:text-slate-400">Explanations</div>
                    <div class="text-base font-extrabold text-purple-600 dark:text-purple-400 mt-0.5">Taglish AI</div>
                </div>
            </div>

            {{-- Main Study Guide Article --}}
            <div class="card flat-card p-6 sm:p-8 mb-10 space-y-7 bg-white dark:bg-slate-800/80">
                {{-- Section 1 --}}
                <div>
                    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2.5">
                        What is the Civil Service Exam Professional Level?
                    </h3>
                    <p class="text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed mb-3">
                ...
                {{-- Pro Tip Callout --}}
                <div class="p-4 sm:p-5 rounded-xl bg-amber-500/10 dark:bg-amber-500/15 border border-amber-500/30 text-slate-900 dark:text-slate-100">
                    <div class="font-extrabold text-sm sm:text-base mb-1 text-amber-700 dark:text-amber-400">ExamReady PH Pro Tip</div>
                    <p class="text-xs sm:text-sm leading-relaxed">The Civil Service Exam does NOT allow calculators! All numerical computations must be solved by hand or mental math. Practicing speed computation techniques is crucial to finishing the exam on time.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed mb-5">
                    ...
                    <div class="space-y-3.5">
                        <div class="card flat-card p-4 sm:p-5 border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-800/90 hover:border-blue-500 transition">
                            <div class="flex flex-wrap items-center justify-between gap-2 mb-2">
                                <h4 class="font-bold text-base text-slate-900 dark:text-white">Numerical Reasoning</h4>
                                <span class="badge-blue text-xs font-semibold px-2.5 py-0.5 whitespace-nowrap">~35–40 items</span>
                            </div>
                            <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">Word problems, percentages, ratio & proportion, number series, basic algebra, data interpretation, and speed math.</p>
                        </div>

                        <div class="card flat-card p-4 sm:p-5 border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-800/90 hover:border-purple-500 transition">
                            <div class="flex flex-wrap items-center justify-between gap-2 mb-2">
                                <h4 class="font-bold text-base text-slate-900 dark:text-white">Analytical Thinking</h4>
                                <span class="badge-purple text-xs font-semibold px-2.5 py-0.5 whitespace-nowrap">~30–35 items</span>
                            </div>
                            <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">Logic puzzles, syllogisms, pattern recognition, data sufficiency, and critical deductive reasoning.</p>
                        </div>

                        <div class="card flat-card p-4 sm:p-5 border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-800/90 hover:border-emerald-500 transition">
                            <div class="flex flex-wrap items-center justify-between gap-2 mb-2">
                                <h4 class="font-bold text-base text-slate-900 dark:text-white">Verbal Ability</h4>
                                <span class="badge-emerald text-xs font-semibold px-2.5 py-0.5 whitespace-nowrap">~40–45 items</span>
                            </div>
                            <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">English & Filipino vocabulary, grammar and correct usage, sentence completion, paragraph organization, and reading comprehension.</p>
                        </div>

                        <div class="card flat-card p-4 sm:p-5 border border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-800/90 hover:border-amber-500 transition">
                            <div class="flex flex-wrap items-center justify-between gap-2 mb-2">
                                <h4 class="font-bold text-base text-slate-900 dark:text-white">General Information & PH Constitution</h4>
                                <span class="badge-amber text-xs font-semibold px-2.5 py-0.5 whitespace-nowrap">~20–25 items</span>
                            </div>
                            <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">1987 Philippine Constitution (Bill of Rights), RA 6713 (Code of Conduct for Public Officials), peace & human rights concepts, and environmental protection laws.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            <div class="w-7 h-7 rounded-full bg-blue-600 text-white font-extrabold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">1</div>
                            <div>
                                <h4 class="text-sm font-bold text-slate-900 dark:text-white mb-0.5">Master Elimination & Estimation in Math</h4>
                                <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">Since calculators are forbidden, estimate answer choices before writing out lengthy equations. Eliminate options that are clearly out of range.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-7 h-7 rounded-full bg-blue-600 text-white font-extrabold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">2</div>
                            <div>
                                <h4 class="text-sm font-bold text-slate-900 dark:text-white mb-0.5">Prioritize High-Weight Subtopics First</h4>
                                <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">Verbal Ability and Numerical Reasoning make up over 50% of the total score. Focus your early review hours on these two categories using our targeted Practice Mode.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-7 h-7 rounded-full bg-blue-600 text-white font-extrabold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">3</div>
                            <div>
                                <h4 class="text-sm font-bold text-slate-900 dark:text-white mb-0.5">Memorize Key Provisions of RA 6713 & Bill of Rights</h4>
                                <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">General Information items are easy points if you memorize the 8 Norms of Conduct under RA 6713 and Article III of the 1987 Philippine Constitution.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-7 h-7 rounded-full bg-blue-600 text-white font-extrabold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">4</div>
                            <div>
                                <h4 class="text-sm font-bold text-slate-900 dark:text-white mb-0.5">Simulate Real Exam Conditions with Timed Mock Exams</h4>
                                <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">You have roughly 67 seconds per question in the actual test. Taking our online Mock Exam trains your pacing so you don't get stuck on difficult questions.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-3">
                            <div class="w-7 h-7 rounded-full bg-blue-600 text-white font-extrabold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">5</div>
                            <div>
                                <h4 class="text-sm font-bold text-slate-900 dark:text-white mb-0.5">Learn from Mistakes via AI Taglish Answer Explanations</h4>
                                <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">Don't just check if your answer is right or wrong. Read the step-by-step Taglish explanation after every practice question to understand *why* the option is correct.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-6" x-data="{ openFaq: null }">
                <div class="text-center mb-8">
                    ...
                    <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mt-1.5">Everything candidates ask about the Civil Service Exam Professional Level</p>
                </div>

                <div class="space-y-3">
                    {{-- FAQ 1 --}}
                    <div class="card flat-card overflow-hidden transition bg-white dark:bg-slate-800">
                        <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 font-semibold text-sm sm:text-base text-slate-900 dark:text-white">
                        ...
                        <div x-show="openFaq === 1" x-collapse class="px-4 sm:px-5 pb-5 text-xs sm:text-sm text-slate-700 dark:text-slate-300 border-t border-slate-100 dark:border-slate-700/50 pt-3 leading-relaxed">
                    ...
                    {{-- FAQ 2 --}}
                    <div class="card flat-card overflow-hidden transition bg-white dark:bg-slate-800">
                        <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 font-semibold text-sm sm:text-base text-slate-900 dark:text-white">
                        ...
                        <div x-show="openFaq === 2" x-collapse class="px-4 sm:px-5 pb-5 text-xs sm:text-sm text-slate-700 dark:text-slate-300 border-t border-slate-100 dark:border-slate-700/50 pt-3 leading-relaxed">
                    ...
                    {{-- FAQ 3 --}}
                    <div class="card flat-card overflow-hidden transition bg-white dark:bg-slate-800">
                        <button @click="openFaq = openFaq === 3 ? null : 3" class="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 font-semibold text-sm sm:text-base text-slate-900 dark:text-white">
                        ...
                        <div x-show="openFaq === 3" x-collapse class="px-4 sm:px-5 pb-5 text-xs sm:text-sm text-slate-700 dark:text-slate-300 border-t border-slate-100 dark:border-slate-700/50 pt-3 leading-relaxed">
                    ...
                    {{-- FAQ 4 --}}
                    <div class="card flat-card overflow-hidden transition bg-white dark:bg-slate-800">
                        <button @click="openFaq = openFaq === 4 ? null : 4" class="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 font-semibold text-sm sm:text-base text-slate-900 dark:text-white">
                        ...
                        <div x-show="openFaq === 4" x-collapse class="px-4 sm:px-5 pb-5 text-xs sm:text-sm text-slate-700 dark:text-slate-300 border-t border-slate-100 dark:border-slate-700/50 pt-3 leading-relaxed">
                    ...
                    {{-- FAQ 5 --}}
                    <div class="card flat-card overflow-hidden transition bg-white dark:bg-slate-800">
                        <button @click="openFaq = openFaq === 5 ? null : 5" class="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 font-semibold text-sm sm:text-base text-slate-900 dark:text-white">
                        ...
                        <div x-show="openFaq === 5" x-collapse class="px-4 sm:px-5 pb-5 text-xs sm:text-sm text-slate-700 dark:text-slate-300 border-t border-slate-100 dark:border-slate-700/50 pt-3 leading-relaxed">
                    ...
                    {{-- FAQ 6 --}}
                    <div class="card flat-card overflow-hidden transition bg-white dark:bg-slate-800">
                        <button @click="openFaq = openFaq === 6 ? null : 6" class="w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 font-semibold text-sm sm:text-base text-slate-900 dark:text-white">
                        ...
                        <div x-show="openFaq === 6" x-collapse class="px-4 sm:px-5 pb-5 text-xs sm:text-sm text-slate-700 dark:text-slate-300 border-t border-slate-100 dark:border-slate-700/50 pt-3 leading-relaxed">
    ...
    <section class="py-14">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-sm sm:text-base text-slate-600 dark:text-slate-400 mb-6">Choose a mode below and begin practicing right now. No registration required for mock exams!</p>
            <div class="flex flex-wrap justify-center gap-3">
