        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
                ...
                <aside class="space-y-6">
                    ...
                    <div class="card flat-card p-6 bg-slate-900 text-white border border-slate-800 rounded-2xl shadow-lg">
                        <h3 class="text-lg font-extrabold text-white tracking-tight leading-snug mb-2">
                        ...
                        <a href="{{ route('reviewers') }}" class="block w-full text-center bg-amber-500 hover:bg-amber-400 text-white font-extrabold text-xs uppercase tracking-wider py-3 px-4 rounded-xl transition shadow-md active:scale-95">
