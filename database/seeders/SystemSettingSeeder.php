...
class SystemSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'groq_api_key', 'value' => '', 'type' => 'encrypted', 'group' => 'ai', 'label' => 'Groq API Key', 'description' => 'API Key from Groq Cloud (gsk_...). Encrypted securely in database.'],
            ['key' => 'groq_model', 'value' => 'llama-3.1-8b-instant', 'type' => 'string', 'group' => 'ai', 'label' => 'Groq AI Model', 'description' => 'Model used for Groq API (default: llama-3.1-8b-instant, llama-3.3-70b-versatile, mixtral-8x7b-32768).'],
            ...
            ['key' => 'ai_primary_model', 'value' => 'llama-3.1-8b-instant', 'type' => 'string', 'group' => 'ai', 'label' => 'Primary AI Model', 'description' => 'Model used by primary provider.'],
